...
git clone https://github.com/iamrh1819/android_device_samsung_exynos7885 -b A14-H device/samsung
...
git clone https://github.com/linux4-bringup-priv/android_hardware_samsung -b lineage-21 hardware/samsung
