...
git clone https://github.com/iamrh1819/android_vendor_samsung_exynos7885.git -b android-13 vendor/samsung

echo 'Cloning Hardware Samsung [4/8]'
# Hardware OSS parts for Samsung
mv hardware/samsung/nfc .
rm -rf hardware/samsung
git clone https://github.com/Roynas-Android-Playground/android_hardware_samsung.git -b thirteen hardware/samsung
...
# Lineage-CP
git clone https://github.com/LineageOS/android_hardware_samsung_slsi_libbt.git -b lineage-20 hardware/samsung_slsi/libbt
git clone https://github.com/LineageOS/android_hardware_samsung_slsi_scsc_wifibt_wifi_hal.git -b lineage-20 hardware/samsung_slsi/scsc_wifibt/wifi_hal
git clone https://github.com/LineageOS/android_hardware_samsung_slsi_scsc_wifibt_wpa_supplicant_lib.git -b lineage-20 hardware/samsung_slsi/scsc_wifibt/wpa_supplicant_lib
...
git clone https://github.com/eurekadevelopment/android_hardware_samsung_slsi-linaro_graphics.git -b lineage-19.1 hardware/samsung_slsi-linaro/graphics
git clone https://github.com/eurekadevelopment/android_hardware_samsung_slsi-linaro_config.git -b lineage-19.1 hardware/samsung_slsi-linaro/config
git clone https://github.com/eurekadevelopment/android_hardware_samsung_slsi-linaro_exynos.git -b lineage-19.1 hardware/samsung_slsi-linaro/exynos
...
git clone https://github.com/eurekadevelopment/android_hardware_samsung_slsi-linaro_openmax.git -b lineage-19.1 hardware/samsung_slsi-linaro/openmax
git clone https://github.com/eurekadevelopment/android_hardware_samsung_slsi-linaro_interfaces.git -b lineage-19.1 hardware/samsung_slsi-linaro/interfaces
